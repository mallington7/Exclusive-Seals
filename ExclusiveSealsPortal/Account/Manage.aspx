...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:RadioButtonList ID="RadioPersonaList" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
                        <asp:ListItem class="radio-inline" Value="0" Text="CPI" Selected="True"></asp:ListItem>
                        <asp:ListItem class="radio-inline" Value="1" Text="RRD"></asp:ListItem>
                  <asp:ListItem class="radio-inline" Value="2" Text="BA"></asp:ListItem>
                    </asp:RadioButtonList>
                 <div class="input-group-btn">
                    <asp:Button   margin-left= "10px" runat="server" ID ="UpdatePersona"  Text="Update" CssClass="btn btn-primary" />
                    </div>
                 </articleb>
